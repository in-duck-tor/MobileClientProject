package com.ithirteeng.secondpatternsclientproject.features.client.myloans.createloan.ui.components
        ...
        ExposedDropdownMenu(
            ...
            state.accounts.forEach { account ->
                DropdownMenuItem(
                    ...
                    onClick = {
                        eventListener(CreateLoanEvent.Ui.ChoosePaymentAccount(account))
                        expanded = false
                    }
                )
            }
